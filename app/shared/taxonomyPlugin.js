...
.controller( 'taxonomyCtrl', ['$scope', '$location', 'endpointService', function AppCtrl ( $scope, $location, endpointService) {
        ...
        var options = {
					serverUrl: "https://dev-term.ihtsdotools.org/snowowl",
        ...
        this.setupCanvas = function() {
            ...
            taxonomyHtml = taxonomyHtml + "<div class='col-md-6' id='" + panel.divElement.id + "-panelTitle'>&nbsp&nbsp&nbsp<strong><span>Taxonomy</span></strong></div>";
