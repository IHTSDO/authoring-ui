...
angular.module('singleConceptAuthoringApp.savedList', [])
  ...
  .controller('savedListCtrl', ['$scope', '$rootScope', '$location', '$modal', 'scaService', 'snowowlService', '$routeParams', 'templateService',
    function savedListCtrl($scope, $rootScope, $location, $modal, scaService, snowowlService, $routeParams, templateService) {
